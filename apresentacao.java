public class Main {
  public static void main(String[] args) {
    ...
    /*
    * ATENÇÃO: Este arquivo Java se destina a apresentação resumida da aplicação e NÃO deve ser acrescentado à pasta/zip do projeto baixado ao executá-lo.
    O projeto baixado em .zip se trata de um projeto Android Studio realizado utilizando a linguagem de programação Java e a versão 2021.1.1 (Bumblebee) do Android Studio.
    */
    ...
    System.out.println("\n\n ==> Projeto desenvolvido por Beatriz Nataly Silva em 2022.");
  }
}
